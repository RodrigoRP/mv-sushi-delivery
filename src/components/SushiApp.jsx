...
⚠️ *Importante:* Enviar comprovante do PIX após o pagamento para confirmação do pedido.`;
  ...
  const restoreBackup = () => {
    setConfirmDialog({
      ...
      message: 'Tem certeza que deseja restaurar o último backup? Isso substituirá os dados atuais.',
  ...
  const exportData = () => {
    ...
    link.href = url;
    link.download = `mv-sushi-backup-${new Date().toISOString().split('T')[0]}.json`;
    link.click();
      ...
      <div className="max-w-7xl mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            <div className="gradient-primary w-12 h-12 rounded-2xl flex items-center justify-center text-2xl">
              🍣
            </div>
            <div>
